// src/pages/MateriTopicListPage.jsx
...
const MateriTopicListPage = () => {
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <p className="text-red-500">Gagal memuat topik materi: {error}</p>
        <button
          onClick={() => navigate(-1)}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Breadcrumb - Link ke MateriCategoryPage */}
      ...
      <div className="mt-6 space-y-4">
        {topics.map((topic) => (
          <div key={topic.id}>
            {topic.is_published ? (
              <Link
                // Link ke MateriSubtopicListPage
                to={`/materi/${categoryId}/${topic.topic_id}`}
...
export default MateriTopicListPage;
